...
public class UpdateAppBean implements Serializable {
    ...
    public boolean isUpdate(Context mContext) {
        return !TextUtils.isEmpty(this.version_number) && !AppUtils.getVersionName(mContext).equals(this.version_number);
    }
    ...
    public UpdateAppBean setVersionNumber(String version_number) {
    ...
    public UpdateAppBean setUpdateDescribe(String update_describe) {
