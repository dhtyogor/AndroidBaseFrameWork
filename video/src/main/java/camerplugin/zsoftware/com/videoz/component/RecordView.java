...
//                stopRecord();
    ...
    public void startRecord(VideoConfig _videoConfig) {
        ...
        //不把 开启时候 嘀的一声录入
        //提示音目录system/media/audio/ui/Cam_Start.ogg和Cam_Stop.ogg两个文件
...
//        // 这两项需要放在setOutputFormat之前
            ...
            mRecorder.setOutputFormat(MediaRecorder.OutputFormat.DEFAULT);//MediaRecorder.OutputFormat.DEFAULT
